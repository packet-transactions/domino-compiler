...
int main(int argc, const char **argv) {
  ...
  const auto prog_decl_pair = run_pass<FuncTransformHandler<ExprFlattenerHandler>, std::pair<std::string, std::vector<std::string>>>(op, clang::ast_matchers::functionDecl().bind("functionDecl"));

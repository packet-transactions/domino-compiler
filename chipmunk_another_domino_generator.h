#ifndef CHIPMUNK_ANOTHER_DOMINO_GENERATOR_H_
#define CHIPMUNK_ANOTHER_DOMINO_GENERATOR_H_
...
public:
  ...
  std::string
  ast_visit_stmt_specially_for_if_condition(const clang::Stmt *stmt);
...
protected:
  ...
  std::string ast_visit_record_decl(const clang::RecordDecl *record_decl,
...
#endif // CHIPMUNK_ANOTHER_DOMINO_GENERATOR_H_

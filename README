1. Ensure you have python-3.5.1 (https://www.python.org/ftp/python/3.5.1/python-3.5.1-macosx10.6.pkg) git g++ (4.9 or higher) build-essential autotools and zlib1g-dev (either using macports or apt-get)
...
4. git clone https://github.com/anirudhSK/banzai.git; cd banzai; ./autogen.sh; ./configure CXX='g++'; sudo make install; cd ..; ./autogen.sh && ./configure CXX='g++' && make

...
/// Transform stateful code blocks (or) equivalently, strongly connected
/// components into sketch specifications.
/// Sketch specifications can then be fed to Sketch to
...
/// that is generic and spans all these functions.

#ifndef NEW_SINGLE_PASS_H_
#define NEW_SINGLE_PASS_H_
...
class NewSinglePass {
 public:
  ...
  NewSinglePass(const std::string & file_name,
             const std::string & help_msg,
             const Transformer & t_transformer);

  /// Output from NewSinglePass
...
template <class OutputType>
NewSinglePass<OutputType>::NewSinglePass(const std::string & file_name,
                                   const std::string & help_msg __attribute__ ((unused)),
                                   const Transformer & t_transformer)
